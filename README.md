...
This project uses original educational prose. It is not a substitute for the official rulebooks and does not imply endorsement by any publisher. Review `THIRD_PARTY_LICENSES.md` before monetizing or adding downloadable rules content.
